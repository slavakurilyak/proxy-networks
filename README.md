...
This proxy network can be useful for various applications, such as web scraping, load testing, or anonymizing traffic. The project provides two setup options: dynamic IP and static IP, allowing users to choose the configuration that best suits their needs.
...
--template-body file://vpc-template-dynamic.yaml

# For static IP setup
aws cloudformation create-stack \
--stack-name proxy-vpc-static \
--template-body file://vpc-template-static.yaml \
...
--template-body file://proxy-infrastructure-dynamic.yaml \
...
--template-body file://proxy-infrastructure-static.yaml \
